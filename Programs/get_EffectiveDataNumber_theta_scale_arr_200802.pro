;Pro get_EffectiveDataNumber_theta_scale_arr_200802
...
file_restore= 'LocalBG_of_MagField_for_AutoCorr(time=*-*)(period=6.0-1999)_recon.sav'
...
;data_descrip= 'got from "get_LocalBG_of_MagField_at_Scales_19760307.pro"'
;Save, FileName=dir_save+file_save, $
;	data_descrip, $
;	JulDay_min, time_vect_v2, period_vect, $
;	Bxyz_LBG_RTN_arr
;;;---
...
;;--
AnnotStr_tmp	= 'got from "get_EffectiveDataNumber_theta_scale_arr_200802.pro"'
