Pro get_Wavelet_Transform_of_BComp_vect_WIND_v2_recon, $
		...
		period_vect=period_vect, scale_vect=scale_vect,Cdelta,psi0,wavepad,dj_wavlet			;output
...
J_wavlet	= num_scales;16;16	;number of scales
...
scale_arr = fltarr(num_periods)+!values.F_nan
...
For i_period=0,num_periods-1 Do Begin
	...
	WaveLetCoeff_arr	= WAVELET(wave_vect,dtime,$		;input
								...
								recon=recon,Cdelta=Cdelta,psi0=psi0,wavepad=wavepad)
	BComp_wavlet_arr(*,i_period)	= WaveLetCoeff_arr(*,0)
	Wait,5.e-2
;	help,Cdelta,psi0,wavepad
EndFor
