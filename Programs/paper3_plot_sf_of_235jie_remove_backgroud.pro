;Pro paper3_plot_SF_of_235jie_remove_backgroud
...
Set_Plot, 'PS';'Win'
Device,filename=dir_restore+'StructFunct_of_Btot_theta_scale_'+'new'+'.eps', $   ;;;;;
...
;  data_descrip, $
;  period_vect, $
;  Bt_SF,Bt_SF_bg,Bt_o, dBx_new, dBy_new, dBz_new, Diff_Bx_arr, Diff_By_arr, Diff_Bz_arr
...
;  data_descrip, $
;  period_vect, $
;  Bt_SF,Bt_SF_bg,Bt_o, Diff_Bx_arr, Diff_By_arr, Diff_Bz_arr
...
;read,'without back:yes(1) or no(0):',is_back
is_back = 1                ;;;;;;;;;;
if is_back eq 1 then begin
str_back = 'new'
Btot_StructFunct_arr = dBx_new^jieshu + dBy_new^jieshu + dBz_new^jieshu
endif
if is_back eq 0 then begin
str_back = 'original'  
Btot_StructFunct_arr = dBx_or^jieshu + dBy_or^jieshu + dBz_or^jieshu
endif
;;;--
...
;===========================
;Step5:
;Btot_StructFunct_arr = Bt_SF
time_vect_StructFunct = time_vect_LBG
;;--
