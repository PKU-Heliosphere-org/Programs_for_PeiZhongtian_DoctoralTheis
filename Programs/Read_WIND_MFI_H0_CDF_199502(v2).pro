;Pro Read_WIND_MFI_H0_CDF_199502(v2)

;sub_dir_date  = 'MFI/2002/';'1995-01--1995-02/';'1995-12-23/'
;sub_dir_date  = '2005-03/'

WIND_MFI_Data_Dir = 'WIND_MFI_Data_Dir=C:\Users\pzt\course\Research\He\mfi_WangLH\';+sub_dir_date
WIND_MFI_Figure_Dir = 'WIND_MFI_Figure_Dir=C:\Users\pzt\course\Research\He\';+sub_dir_date
...
;;--
dir_read  = GetEnv('WIND_MFI_Data_Dir')
file_read = 'wi_h0*_mfi_2002*_*.cdf'
...
;;--
dir_save  = GetEnv('WIND_MFI_Data_Dir')
;a file_save = 'Bxyz_GSE_arr'+TimeRange_str+'('+file_version+').sav'
...
file_version= '(H0)'
dir_fig   = GetEnv('WIND_MFI_Figure_Dir')
