...
If i_BComp eq 1 Then Begin
  BComp_RTN_vect  = 22.0*reform(Bxyz_GSE_2s_arr(0,*))/sqrt(P_DEN_3s_arr);reform(Bxyz_GSE_2s_arr(0,*))
  zf = 'b_n'
EndIf
If i_BComp eq 2 Then Begin
  BComp_RTN_vect  = 22.0*reform(Bxyz_GSE_2s_arr(1,*))/sqrt(P_DEN_3s_arr);reform(Bxyz_GSE_2s_arr(1,*))
  zf = 'b_n'  
EndIf
If i_BComp eq 3 Then Begin
  BComp_RTN_vect  = 22.0*reform(Bxyz_GSE_2s_arr(2,*))/sqrt(P_DEN_3s_arr);reform(Bxyz_GSE_2s_arr(2,*))
  zf = 'b_n'  
EndIf
