;Pro get_MagDeflectionAngle_time_scale_arr_WIND_19950131
...
file_restore= 'uy_1sec_vhm_19950721_v01.sav'
...
;;--
scale_min	= 6.0;4,1.0;1.e0	;unit: s
scale_max	= 1.e3;1.e3,1.e5
scale_range	= [scale_min, scale_max]
num_scales	= 32 ;16;16	;number of scales
dlg2scale	= ALog10(scale_max/scale_min)/ALog10(2)/(num_scales-1)
scale_vect	= scale_min*2.^(Lindgen(num_scales)*dlg2scale)
...
file_save	= 'MagDeflectAng_time_scale_arr'+$
				TimeRange_str+'.sav'
...
file_version= '(v1)'
file_fig	= 'MagDeflectionAngle_time_scale_arr'+$
				TimeRange_str+$
				file_version+$
				'.png'
