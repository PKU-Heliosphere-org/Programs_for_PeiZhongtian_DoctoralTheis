...
If JulDay_range gt 2.9 Then Begin
	dJulDay_tick	= 1.0
	xminor_time		= 4
EndIf Else Begin
...
If JulDay_range gt 1./(24*60)*10. Then Begin
	dJulDay_tick	= Double(1.)/(24*60)*(10./3.)
	xminor_time		= 10
EndIf Else Begin
If JulDay_range gt 1./(24*60) Then Begin
	dJulDay_tick	= Double(1.0)/(24*60)
	xminor_time		= 6
EndIf Else Begin
...
For i_tick=0,num_ticks Do Begin
	...
	If dJulDay_tick gt 1./(24*60) Then Begin
		xtickname_tmp	= String(mon_tmp, Format='(I2.2)')+'/'+$
              String(day_tmp, Format='(I2.2)')+'/'+String(hour_tmp, Format='(I2.2)')+':'+$
							String(min_tmp, Format='(I2.2)')
	EndIf Else Begin
		xtickname_tmp	= String(day_tmp, Format='(I2.2)')+'/'+String(hour_tmp, Format='(I2.2)')+':'+$
							String(min_tmp, Format='(I2.2)')+':'+$
