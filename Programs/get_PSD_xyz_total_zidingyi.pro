;pro get_PSD_xyz_total_zidingyi
;
...
plot,1.0/period_vect,PSD_BComp,color=color_black,yrange=[0.001,1000.0],xtitle='frequency(Hz)',ytitle='PSD(nT^2)',/xlog,/ylog
...
dir_restore = 'C:\Users\pzt\course\Research\CDF_wind\'+sub_dir_date
file_restore = 'PSD_'+'Bx'+'_time_scale_arr(time=*-*)'+zf+'.sav'
file_array  = File_Search(dir_restore+file_restore, count=num_files)
i_select  = 0
file_restore  = file_array(i_select)
...
dir_restore = 'C:\Users\pzt\course\Research\CDF_wind\'+sub_dir_date
file_restore = 'PSD_'+'By'+'_time_scale_arr(time=*-*)'+zf+'.sav'
file_array  = File_Search(dir_restore+file_restore, count=num_files)
i_select  = 0
file_restore  = file_array(i_select)
Restore, file_restore
...
dir_restore = 'C:\Users\pzt\course\Research\CDF_wind\'+sub_dir_date
file_restore = 'PSD_'+'Bz'+'_time_scale_arr(time=*-*)'+zf+'.sav'
file_array  = File_Search(dir_restore+file_restore, count=num_files)
i_select  = 0
file_restore  = file_array(i_select)
Restore, file_restore
...
dir_save = 'C:\Users\pzt\course\Research\CDF_wind\'+sub_dir_date
file_save = 'PSD_'+'Btotal'+'_time_scale_arr(time=0-0)'+zf+ $
        '.sav'
data_descrip= 'got from "get_PSD_of_BComp_theta_scale_arr_200802.pro"'
Save, FileName=dir_save+file_save, $
  data_descrip, $
...
dir_fig   = 'C:\Users\pzt\course\Research\CDF_wind\'+sub_dir_date
file_version= '(v1)'
file_fig  = 'PSD_of_'+'Btotal'+'_time_scale_arr'+$
        file_version+zf+ $
        '.png'
Write_PNG, dir_fig+file_fig, image_tvrd
