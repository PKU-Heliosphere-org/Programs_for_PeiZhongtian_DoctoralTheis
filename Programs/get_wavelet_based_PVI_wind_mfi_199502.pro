...
;;;---
Syz_wavlet_arr  = By_wavlet_arr*Conj(Bz_wavlet_arr)
...
;;--
year_beg_plot=1995 & mon_beg_plot=12 & day_beg_plot=25
hour_beg_plot=10 & min_beg_plot=20 & sec_beg_plot=0
year_end_plot=1995 & mon_end_plot=12 & day_end_plot=25
hour_end_plot=10 & min_end_plot=27 & sec_end_plot=0
...
PVI_wavelet_time_scale_arr_TV = Sqrt(PSD_Bt_time_scale_arr_TV_v2) / Sqrt(AverPSD_Bt_time_scale_arr)

i_period_v1 = 3L
period_v1   = period_vect_TV(i_period_v1)
PVI_wavelet_time_scale1_vect  = PVI_wavelet_time_scale_arr_TV(*,i_period_v1)
i_period_v2 = 4L
period_v2   = period_vect_TV(i_period_v2)
PVI_wavelet_time_scale2_vect  = PVI_wavelet_time_scale_arr_TV(*,i_period_v2)
i_period_v3 = 5L
period_v3   = period_vect_TV(i_period_v3)
PVI_wavelet_time_scale3_vect  = PVI_wavelet_time_scale_arr_TV(*,i_period_v3)
...
yplot_vect_v1 = PVI_wavelet_time_scale1_vect
yplot_vect_v2 = PVI_wavelet_time_scale2_vect
yplot_vect_v3 = PVI_wavelet_time_scale3_vect
;;;---
xtitle  = TexToIDL(' ')
ytitle  = 'period (s)'
title = TexToIDL('wavelet_PVI')
;;;---
xrange  = [Min(JulDay_vect_TV), Max(JulDay_vect_TV)]
yrange  = [0.0, 3.5]
xrange_time = xrange
...
Plot,xplot_vect,yplot_vect_v1,XRange=xrange,YRange=yrange,XStyle=1,YStyle=1,$
  ...
  XTicks=xticks,XTickV=xtickv,XTickName=xticknames,XMinor=xminor,XTickLen=0.04,$
  XTitle=xtitle,YTitle=ytitle,$
  NoData=0,Color=color_black,$
  /NoErase,Font=-1,CharThick=1.0,Thick=1.0,YLog=0
Plots,xplot_vect,yplot_vect_v2,Color=color_red
Plots,xplot_vect,yplot_vect_v3,Color=color_blue
XYOuts, xrange(0)+0.5*(xrange(1)-xrange(0)), yrange(0)+0.8*(yrange(1)-yrange(0)), $
      'periods black/red/blue: '+String(period_v1,format='(F3.1)')+', '+String(period_v2,format='(F3.1)')+', '+String(period_v3,format='(F3.1)'), $
      Color=color_black, /Data, CharSize=1.1
...
AnnotStr:
;;--
AnnotStr_tmp  = 'got from "get_wavelet_based_PVI_WIND_MFI_199502.pro"'
