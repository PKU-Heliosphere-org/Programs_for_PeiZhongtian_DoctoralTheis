;Pro Restore_Plot_BiDirect_EnerFlux_SST
...
mon_str   = '03'
day_str   = '11'
sub_dir_date  = year_str+'-'+mon_str+'-'+day_str+'/'
dir_data  = '/Work/Data Analysis/WIND data process/Data/'+$
            year_str+'-'+mon_str+'/'+$
            sub_dir_date
dir_fig   = '/Work/Data Analysis/WIND data process/Figures/'+$ 
            year_str+'-'+mon_str+'/'+$
            sub_dir_date  
...
;;--
file_data = 'SST_engflx_2005Mar11.dat'
...
;a    XTitle=xtitle,YTitle=ytitle,$
  ...
  xyouts_str  = String(xyouts_vect(i_eng), format='(g10.5)')
...
;;--
AnnotStr_tmp  = 'got from "Restore_Plot_BiDirect_EnerFlux_SST.pro"'
...
file_fig= 'BiDirect_EnerFlux_p&e_SST'+$
        ...
        '.png'
EndIf Else Begin
file_fig= 'BiDirect_Flux_p&e_SST'+$
        timerange_str_plot+$
        '('+year_str+mon_str+day_str+')'+$
        file_version+$
        '.png'
