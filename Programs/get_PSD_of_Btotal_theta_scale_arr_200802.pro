;Pro get_PSD_of_Btotal_theta_scale_arr_200802
...
file_restore= 'Bx'+'_wavlet_arr(time=*-*)_recon.sav'
...
PSD_Btotal_theta_scale_arr_TV= PSD_BComp_theta_scale_arr(*,*)
...
;;;---
image_TV  = ALog10(PSD_Btotal_theta_scale_arr_TV)
...
if num_Numerator_tmp LT 50.0 then begin         ;可改
...
titleCB     = TexToIDL('lg(PSD'+'Btotal'+')')
bottom_color  = 0B
...
file_version= '(v1)'
file_fig  = 'PSD_of_'+'Btotal'+'_theta_scale_arr'+$
        TimeRange_str+$
        file_version+$
        '_recon.png'
