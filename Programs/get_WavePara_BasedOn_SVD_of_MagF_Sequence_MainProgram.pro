;Pro get_WavePara_BasedOn_SVD_of_MagF_Sequence_MainProgram
...
sub_dir_date= '2005-03/';'1995-01--1995-02/'
;a sub_dir_date= '1995-05/';'1995-01--1995-02/';'1995-'+mon_str+'-'+day_str+'/'
sub_dir_name= ''

dir_data_v1 = '/Work/Data Analysis/WIND data process/Data/'+sub_dir_name+sub_dir_date+''
dir_data_v2 = '/Work/Data Analysis/MFI data process/Data/'+sub_dir_date+''
dir_fig     = '/Work/Data Analysis/WIND data process/Figures/'+sub_dir_name+sub_dir_date+''
...
hour_beg=13.0 & min_beg=0.0 & sec_beg=0.0 ;From 'TimeStr_beg_seg_SWP_A/SWMS_vect' & 'TimeStr_end_seg_SWP_A/SWMS_vect' as resulted from 'get_CorrCoeffs_B_V_Components_EveryTimeInterval.pro'
hour_end=17.0 & min_end=0.0 & sec_end=0.0 ;time interval usually =5 or 10 min (<30min)
...
For i=0,14 Do Begin
  ...
  If i eq 12 Then wave_vect = Bx_GSE_vect_plot
  If i eq 13 Then wave_vect = By_GSE_vect_plot
  If i eq 14 Then wave_vect = Bz_GSE_vect_plot
...
;;--
AnnotStr_tmp  = 'got from "get_WavePara_BasedOn_SVD_of_MagF_Sequence_MainProgram.pro"'
...
EndIf Else Begin
  file_version  = '(TV)'
EndElse  
file_fig= 'WavePara_of_MagF(from SVD)'+$
        timerange_str_plot+$
