...
JulDay_2s_vect = 2453642.5+lindgen(n_GT30)/86400.0
MagDeflectAng_arr = MagDeflectAng_arr(subGT30,*)
...
file_save = 'MagDeflectAng_time_scale_GT_arr'+$
        TimeRange_str+'.sav'
