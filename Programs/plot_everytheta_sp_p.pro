...
for i=0,num_theta_bins-1 do begin
 ...
 YRange=[0.0,8.0] 
  Plot, xrange, yrange, XRange=xrange, YRange=yrange, XStyle=1,YStyle=1,  $  ;range
    XTitle='p', YTitle='S', xcharsize=2,ycharsize=2,charthick=2,position=position, $
    /NoErase, /NoData
  Plots, p, slope(i,*)+ds(i),Thick=1.5,color='0000ff'XL
 ...
 YRange=[0.0,8.0] 
  Plot, xrange, yrange, XRange=xrange, YRange=yrange, XStyle=1,YStyle=1,  $  ;range
    XTitle='p', YTitle='S', xcharsize=2,ycharsize=2,charthick=2,position=position, $
    /NoErase, /NoData
  Plots, p, slope(i,*)+ds(i),Thick=1.5
  ErrPlot, p, slope(i,*)+ds(i)-sigmaslope(*,i), slope(i,*)+ds(i)+sigmaslope(*,i), $
    Thick=1.5
 endelse 
...
;file_version= '(v1)'
file_fig  = 'slope_of_s(p)_vs_theta_tao_color'+$
        '.png'
