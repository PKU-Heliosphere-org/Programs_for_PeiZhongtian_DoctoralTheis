;pro paper3_plot_line_SF_235jie
...
;;;--
Set_Plot, 'PS';'Win'
Device,filename=dir_restore+'StructFunct_VS_tau_slowguan.eps', $   ;
...
xrange = [min(period_vect),max(period_vect)]
...
yrange = [min(sf_scale)/10.,max(sf_scale)*10.]
