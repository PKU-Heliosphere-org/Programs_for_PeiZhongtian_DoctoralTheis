;pro get_wavlet_vv_zidingyiscale
...
If i_BComp eq 1 Then Begin
  BComp_RTN_vect  = reform(P_VEL_3s_arr(0,*));reform(P_VEL_3s_arr(0,*))*sqrt(P_DEN_3s_arr)/22.0;
EndIf
If i_BComp eq 2 Then Begin
  BComp_RTN_vect  = reform(P_VEL_3s_arr(1,*));reform(P_VEL_3s_arr(1,*))*sqrt(P_DEN_3s_arr)/22.0;
EndIf
If i_BComp eq 3 Then Begin
  BComp_RTN_vect  = reform(P_VEL_3s_arr(2,*));reform(P_VEL_3s_arr(2,*))*sqrt(P_DEN_3s_arr)/22.0;
EndIf
