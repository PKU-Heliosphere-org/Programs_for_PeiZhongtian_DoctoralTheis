;pro get_crosscorrelation_of_Vx_n
...
read,'Vx&n(1) or Vx&B(2) or B&n(3) or Vy&n(4)',select

if select eq 1 then begin
wave_vect1 = reform(P_VEL_3s_arr(0,*))
wave_vect2 = P_DEN_3s_arr
liang = 'Vx&n'
endif
...
file_save = 'Correlation_'+'_of_'+liang+$
        '.sav'
data_descrip= 'got from "get_crosscorrelation_of_Vx_n.pro"'
Save, FileName=dir_save+file_save, $
  data_descrip, $
