;pro calculate_Statistical_features_1D_0D
...
file_restore= 'wi_pm_3dp_20071113-16_v03.sav'
...
for i = 0,2 do begin
  if i eq 0 then begin
    Bcomp_vect = Px_VEL_3s_vect
    Sstr = 'Vx'
  endif
  if i eq 1 then begin
    Bcomp_vect = Py_VEL_3s_vect
    Sstr = 'Vy'
  endif    
  if i eq 2 then begin
    Bcomp_vect = Pz_VEL_3s_vect
    Sstr = 'Vz'
  endif
...
file_save = 'wind_velocity_vari_piandu_peak_arr'+$
        TimeRange_str+$
        PeriodRange_str+$
        '.sav'
