;pro poster_get_deltaB_sigma_15day_v
...
datanum_bin_15 = fltarr(15,num_theta_bins,num_periods)+!values.f_nan
mean_Bt_15 = fltarr(15,num_theta_bins,num_periods)+!values.f_nan
second_moment_15 = fltarr(15,num_theta_bins,num_periods)+!values.f_nan
fourth_moment_15 = fltarr(15,num_theta_bins,num_periods)+!values.f_nan
datanum_bin = fltarr(num_theta_bins,num_periods)+!values.f_nan
mean_Bt = fltarr(num_theta_bins,num_periods)+!values.f_nan
second_moment = fltarr(num_theta_bins,num_periods)+!values.f_nan
fourth_moment = fltarr(num_theta_bins,num_periods)+!values.f_nan
flatness_theta_arr = fltarr(num_theta_bins,num_periods)+!values.f_nan
...
For i_theta=0,num_theta_bins-1 Do Begin
 ...
 ;   flatness_mean_15(i_slow-1,i_theta,i_period) = flatness_tmp
     datanum_bin_15(i-1,i_theta,i_period) = n_elements(sub_tmp)
     second_moment_15(i-1,i_theta,i_period) = mean(delta_Bt_arr(sub_tmp,i_period)^2,/nan)
     fourth_moment_15(i-1,i_theta,i_period) = mean(delta_Bt_arr(sub_tmp,i_period)^4,/nan)     
...
For i_period=0,num_periods-1 Do Begin
For i_theta=0,num_theta_bins-1 Do Begin
  datanum_bin(i_theta,i_period) = total(datanum_bin_15(*,i_theta,i_period),/nan)
  second_moment(i_theta,i_period) = total(datanum_bin_15(*,i_theta,i_period)*second_moment_15(*,i_theta,i_period),/nan)/datanum_bin(i_theta,i_period)
  fourth_moment(i_theta,i_period) = total(datanum_bin_15(*,i_theta,i_period)*fourth_moment_15(*,i_theta,i_period),/nan)/datanum_bin(i_theta,i_period)  
EndFor
EndFor



file_save ='N_sigma_deltaB_v.sav'
