;pro figure4_fit_sp_freq_and_sp_p





sub_dir_date1  = 'wind\fig\'
...
file_save = 'slope_of_s(p)_vs_tao_theta_guan_day10-12_V2'+'.sav';;;;;
...
file_restore= 'slope_of_s(p)_vs_tao_theta'+'_guan_day10-12_V2.sav';;;;;;;;
file_array  = File_Search(dir_restore+file_restore, count=num_files)
For i_file=0,num_files-1 Do Begin
  Print, 'i_file, file: ', i_file, ': ', file_array(i_file)
EndFor
...
;  theta_bin_cen_vect_plot, slope_fast, sigmaslope_fast, slope_slow, sigmaslope_slow
 ...
 re_A_fast = fltarr(2,n_d,n_theta) 
 re_sigma_fast = fltarr(2,n_d,n_theta)
 re_A_slow = fltarr(2,n_d,n_theta) 
 re_sigma_slow = fltarr(2,n_d,n_theta)
...
F1 = (-2.5+1.5*A(0))*(1.*X/3)+1-bx1;;;;2.5;3.5
...
file_version= '(v1)'
file_fig  = 'over2_theta'+'_'+strcompress(string(10*(i_theta+0.5)),/remove_all)+'_fit_sp_p_day10-12_fast'+  $
       '_guan_V2.png';;;;;;
...
dir_fig   = 'C:\Users\pzt\course\Research\CDF_wind\'+sub_dir_date1
file_version= '(v1)'
file_fig  = 'over2_theta'+'_'+strcompress(string(10*(i_theta+0.5)),/remove_all)+'_fit_sp_p_day10-12_slow'+  $
       '_guan_V2.png';;;;;;
Write_PNG, dir_fig+file_fig, image_tvrd
...
dir_save  = 'C:\Users\pzt\course\Research\CDF_wind\'+sub_dir_date1
file_save = 'extpmodel_theta_alpha_P1'+'_over2_V2.sav';;;;;;
