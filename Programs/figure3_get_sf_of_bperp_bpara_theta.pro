;pro figure3_get_SF_of_Bperp_Bpara_theta
...
;;--
dir_restore = 'C:\Users\pzt\course\Research\CDF_wind\'+sub_dir_date
file_restore=  'LocalBG_of_MagField_for_AutoCorr_'+'1-5'+'_guan'+'_(time=*-*)(period=*-*).sav'
file_array  = File_Search(dir_restore+file_restore, count=num_files)
For i_file=0,num_files-1 Do Begin
  Print, 'i_file, file: ', i_file, ': ', file_array(i_file)
EndFor
...
file_save = 'StructFunct_'+'1-5'+'_'+strcompress(string(jieshu),/remove_all)+'_guan_'+'Bperp_Bpara_theta_period_arr'+$
        TimeRange_str+$
        PeriodRange_str+ $
        'V2.sav'
